...
export default function Financial() {
  ...
  return (
    <AppLayout>
      <div className="container max-w-7xl mx-auto py-6 md:py-8 px-4 md:px-6 space-y-8 pb-24 overflow-x-hidden">
            ...
            <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  {/* 🚀 Ajuste Nível Ouro: w-40, color-scheme:dark para inverter a cor do ícone nativo e estilização webkit */}
                  <Input 
                    type="date" 
